    ...
    <div class="admin-container">
        <div class="admin-section admin-section1 ">
            <ul>
                ...
                <li><i class="fas fa-film"></i><a href="">Ažuriraj film</a></li>
                <li class="admin-navigation-schedule"><i class="fas fa-film"></i>Obriši film</li>     
				<li class="admin-navigation-schedule"><i class="fas fa-film"></i>Dodaj admina</li> 
