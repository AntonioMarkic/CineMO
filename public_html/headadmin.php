...
<body>
    ...
    <div class="admin-container">
        <div class="admin-section admin-section1 ">
            <ul>
                <li><i class="fas fa-film"></i><a href="dodajfilm.php">Dodaj film </a></li>
                <li><i class="fas fa-film"></i><a href="update.php">Ažuriraj film</a></li>
                <li class="admin-navigation-schedule"><i class="fas fa-film"></i><a href="delete.php">Obriši film</a></li>     
				<li class="admin-navigation-schedule"><i class="fas fa-film"></i><a href="dodajadmina.php">Dodaj admina</a></li> 
                <li><i class="fas fa-film"><a href="index.php"></i>Odjava</a></li>
            </ul>
        </div>
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "                                <a href='reject.php?id=".$row['bookingID']."'><i class=\"fas fa-times decline-booking\" title=\"Reject booking\"></i></a>\n";
                                    echo "                            </div>\n";
